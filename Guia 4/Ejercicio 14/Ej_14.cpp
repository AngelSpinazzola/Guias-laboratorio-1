...
Cada aula tiene una capacidad total de 60 personas. Se necesita un programa que solicite la cantidad de asistentes a la charla y  determine la cantidad total de aulas necesarias para acomodarlos a todos.
...
int main()
{
    int cantAulas=0, cantAsistentes, contVueltas=0;

    cout << "Cantidad de asistentes: ";
    cin >> cantAsistentes;

    while(contVueltas < cantAsistentes)
    {
        contVueltas+=60;
        cantAulas++;
    }
