...
int main(){
   ...
   float imp_sin_desc, imp_con_desc;

   cout << "Ingresar el importe sin descuento: ";
   cin >> imp_sin_desc;
   cout << "Ingresar el importe con descuento: ";
   cin >> imp_con_desc;

   cout << "Porcentaje de descuento aplicado: " << ((imp_sin_desc - imp_con_desc) * 100) / imp_sin_desc << "% " << endl;
