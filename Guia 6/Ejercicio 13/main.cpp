...
int main(){
    ...
    int matrizStock[2][15] ={};
    int registrarVentas[15]={};
    int matrizArticuloXSucursal[15][4]={};

    registrarDatos(matrizStock, registrarVentas, matrizArticuloXSucursal);
    mostrarPuntoA(registrarVentas);
    mostrarPuntoB(matrizArticuloXSucursal);
    mostrarPuntoC(matrizArticuloXSucursal);
    mostrarPuntoD(matrizStock);
    mostrarPuntoE(matrizStock);
